...
function result(){
  ...
  // let one = ''
  // if (document.querySelector('input[name=qOne]:checked') !== null) {
  //   one = document.querySelector('input[name=qOne]:checked').value
  // }
  // let two = ''
  // if (document.querySelector('input[name=qTwo]:checked') !== null) {
  //   one = document.querySelector('input[name=qTwo]:checked').value
  // }
  // let three = ''
  // if (document.querySelector('input[name=qThree]:checked') !== null) {
  //   one = document.querySelector('input[name=qThree]:checked').value
  // }
  // let four = ''
  // if (document.querySelector('input[name=qFour]:checked') !== null) {
  //   one = document.querySelector('input[name=qFour]:checked').value
  // }
  // let five = ''
  // if (document.querySelector('input[name=qFive]:checked') !== null) {
  //   one = document.querySelector('input[name=qFive]:checked').value
  // }
  // if(one === '' || two === '' || three === '' || four === '' || five === ''){
  // alert('Complete the form, you donut!')
  // return
  // }
  ...
  if (maxElement === 'a'){
    ...
    const adjectiveTwo = ['Strong', 'Scrappy', 'Sassy', 'Quiet', 'Red']
